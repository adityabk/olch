...
class Mage_Checkout_CartController extends Mage_Core_Controller_Front_Action
{
     ...
     */
    protected function _updateAjaxShoppingCart()
    {        
        try { 
            ...
            if (is_array($cartData)) {
                ...
                //print_r($cartData); 
   /*$myhtml = Mage::getSingleton('checkout/cart');
   $myhtml .= $this->loadLayout();
   $myhtml .= $this->getLayout()->getBlock('checkout/cart');
   // $this->setTemplate('checkout/ajaxcart.phtml');
   $myhtml .=$this->renderLayout();
   // $this->toHtml();
    */
    /*$this->loadLayout();
    $this->getLayout()->createBlock('appmanager/appmanager');
    $this->setTemplate('checkout/ajaxcart.phtml');
    $this->renderLayout();
    $this->toHtml*/
                //$this->ajaxupdatecartAction();     
                return Mage::getSingleton('checkout/cart');
          //echo $myhtml;      
          exit;
            }
